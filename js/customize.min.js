...
function separate($element, prefix, key, value) {
    ...
    switch (typeof value) {
        ...
        case 'string':
            process($element, prefix, key, type, value);
            break;
    }
}

function process($element, prefix, key, type, value) {
    switch (type) {
        case 'class':
            $element.addClass(value);
            break;
        case 'theme':
            $element.find('.colored').removeClass('colored').addClass(value.color);
            $element.find('.colored-text').removeClass('colored-text').addClass(value.color + '-text');
            break;
        case 'image':
